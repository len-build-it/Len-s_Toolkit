...
Read [the index](../SPEC_INDEX.md), its four product documents, [the feature](../features/FEAT-001-spec-first-workflow.md), and [the plan](../plans/FEAT-001-implementation.md).
...
See [verification evidence](../evidence/FEAT-001-verification.md).
